...
public class Main {
    public static void main(String[] args) {
        ...
        partide[0] = new Partida(utilizatori[0], utilizatori[1], "1.e4 e5 2.Nf3 Nc6 3.Bc4 Bc5 4.b4 Bxb4 5.c3 Ba5 6.d4 exd4 7.O-O" +
                "d3 8.Qb3 Qf6 9.e5 Qg6 10.Re1 Nge7 11.Ba3 b5 12.Qxb5 Rb8 13.Qa4" +
                "Bb6 14.Nbd2 Bb7 15.Ne4 Qf5 16.Bxd3 Qh5 17.Nf6+ gxf6 18.exf6" +
                "Rg8 19.Rad1 Qxf3 20.Rxe7+ Nxe7 21.Qxd7+ Kxd7 22.Bf5+ Ke8" +
                "23.Bd7+ Kf8 24.Bxe7# 1-0");
        partide[1] = new Partida(utilizatori[0], utilizatori[2], "1. e4 e6 2. d4 d5 3. Nc3 c5 4. Nf3 Nc6 5. exd5 exd5 6. Be2 Nf6 7. O-O Be7 8. Bg5" +
        ...
        partide[2] = new Partida(utilizatori[2], utilizatori[3], "1.e4 e5 2.Nf3 d6 3.d4 Bg4 4.dxe5 Bxf3 5.Qxf3 dxe5 6.Bc4 Nf6 7.Qb3 Qe7 8.Nc3 c6 9.Bg5 b5 10.Nxb5 cxb5 11.Bxb5+ Nbd7 12.O-O-O Rd8 13.Rxd7 Rxd7 14.Rd1 Qe6 15.Bxd7+ Nxd7 16.Qb8+ Nxb8 17.Rd8# 1-0");
        ...
        conversatii = service.adaugaConversatie(conversatii, nouaConversatie);

        Prietenie nouaPrietenie = new Prietenie(utilizatori[4], utilizatori[1], "04.13.2024");
        prietenii = service.adaugaPrietenie(prietenii, nouaPrietenie);

        System.out.println("Utilizatori cu cel putin doua turnee:");
        service.afiseazaUtilizatoriCuDouaTurnee(utilizatori, turnee);

        System.out.println("\nUtilizatori ordonati dupa rating-ul de blitz:\n");
        Utilizator[] utilizatoriDupaRatingBlitz = service.ordoneazaUtilizatoriDupaRatingBlitz(utilizatori, rating);
        for (Utilizator utilizator : utilizatoriDupaRatingBlitz) {
            System.out.println(utilizator.getUsername());
        }

        System.out.println("\n");
        service.afiseazaUtilizatorCuCelMaiMareRating(rating);

        System.out.println("\nCategorii de membri:");
        service.afiseazaCategoriiMembru(plati, utilizatori);

        System.out.println("\nUtilizatori cu conversatii:");
        service.afiseazaUtilizatoriCuConversatii(conversatii);

        System.out.println("\nUtilizatori cu invitatii la turneu:");
        service.afiseazaUtilizatoriCuInvitatiiLaTurneu(mesaje);

        System.out.println("\nPrieteniile facute dupa 2023:");
        service.afiseazaPrieteniiDupa2023(prietenii);

        System.out.println("\nPartidele cu cel putin 20 de mutari:");
        service.afiseazaPartideleCuCelPutin20Mutari(partide);
    }
}